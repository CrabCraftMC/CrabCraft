...
const ICON_MAP: Record<string, string> = {
  ...
  mine_resin_clump: "Resin_Clump",
  mine_snow: "Snowball",
  mine_spawner: "Spawner",
  mine_stone: "Stone",
  mine_total: "Netherite_Pickaxe",
  mine_wood: "Oak_Log",

  // Combat
  damage_absorbed: "Golden_Apple",
  damage_dealt: "Diamond_Sword",
  damage_dealt_absorbed: "Diamond_Sword",
  damage_dealt_resisted: "Netherite_Axe",
  damage_resisted: "Netherite_Chestplate",
  ...
  craft_rails: "Powered_Rail",
  craft_recovery_compass: "Recovery_Compass",
  craft_redstone_components: "Redstone_Dust",
  ...
  interact_cauldron: "Cauldron",
  interact_grindstone: "Grindstone",
  interact_inspectors: "Dispenser",
  interact_lectern: "Lectern",
  interact_laundry: "Leather_Tunic",
  interact_loom: "Loom",
  ...
  use_golden_dandelion: "Golden_Dandelion",
  use_hoe: "Diamond_Hoe",
  use_honey_bottle: "Honey_Bottle",
  use_lava_bucket: "Lava_Bucket",
  use_name_tag: "Name_Tag",
  use_potion: "Potion",
  use_shears: "Shears",
  ...
  place_cactus: "Cactus",
  place_candle: "Candle",
  place_color_blocks: "Magenta_Glazed_Terracotta",
  place_copper: "Oxidized_Cut_Copper",
  place_chorus_flower: "Chorus_Flower",
  place_conveyor: "Hopper",
  place_decor: "Painting",
  place_doors: "Oak_Door",
  place_electrics: "Redstone_Dust",
  place_glass: "Glass",
  place_lantern: "Lantern",
  place_lights: "Ochre_Froglight",
  place_lightning_rod: "Lightning_Rod",
  place_lodestone: "Lodestone",
  place_masonry: "Stone_Bricks",
  place_plants: "Moss_Block",
  place_piston: "Piston",
  place_rails: "Rail",
  place_sapling: "Oak_Sapling",
  place_scaffolding: "Scaffolding",
  place_sign: "Oak_Sign",
  place_slabs: "Smooth_Stone_Slab",
