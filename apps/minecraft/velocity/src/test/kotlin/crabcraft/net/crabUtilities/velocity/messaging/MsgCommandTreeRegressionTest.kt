...
object MsgCommandTreeRegressionTest {
    ...
    fun main(args: Array<String>) {
        ...
        check(root.getChild("msg") === crabMsg, "the backend /msg node was not replaced by CrabUtilities")
        check(
            root.getChild("msg").getChild("target") != null,
            "the CrabUtilities target argument was missing from /msg",
        )
        check(root.getChild("message") === crabMessage, "the CrabUtilities /message node was not added")
    }
