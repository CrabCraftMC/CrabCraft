...
/** Loads enabled reader definitions from the runtime-editable awards table. */
class AwardLoader private constructor() {
    companion object {
        ...
        @JvmStatic
        fun loadAll(dataSource: HikariDataSource, logger: Logger): Map<String, AwardDefinition> {
                        ...
                        stmt.executeQuery().use { rs ->
                            while (rs.next()) {
                                ...
                                try {
                                    ...
                                    reader.patterns =
                                        if (readerPatternsJson == null) null
                                        else GSON.fromJson(readerPatternsJson, STRING_LIST_TYPE)
                                } catch (e: Exception) {
