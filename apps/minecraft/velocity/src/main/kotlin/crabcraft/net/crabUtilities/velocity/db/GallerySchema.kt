...
/** Initialises the gallery schema shared with packages/db/src/schema.ts. */
class GallerySchema {
    private constructor() {}

    companion object {
        private val CREATE_SCHEMA_SQL: Array<String> =
            arrayOf(
                ("""
            ...
            try {
                dataSource.connection.use { connection ->
                    connection.createStatement().use { statement ->
                        val previousAutoCommit: Boolean = connection.autoCommit
