...
/** Canonical per-player settings store; JSON is retained verbatim as text. */
class PlayerSettingsRepository {
    ...
    companion object {
        ...
        private val SELECT_SQL: String = "SELECT settings FROM player_settings WHERE minecraft_uuid = ?"
