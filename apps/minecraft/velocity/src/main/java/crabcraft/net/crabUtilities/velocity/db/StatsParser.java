...
public class StatsParser {
    ...
    public static ComputedStats parse(String rawJson) {
        ...
        stats.totalBlocksPlaced = sumBlocksPlaced(used);
    ...
    private static int sumBlocksPlaced(JsonObject used) {
        // The "used" category includes both block placements and item uses
        // Block items typically contain "block" in their name or are in the blocks list
        // For simplicity, sum all entries (matches the original behavior)
        return sumCategory(used);
    }
