...
final class LofiVoicechatRegressionTest {
    ...
    private static void verifyDefaultsAndLegacyNamespace() throws Exception {
        String config;
        try (var input = LofiVoicechatRegressionTest.class.getClassLoader()
                .getResourceAsStream("modules/voicechat.yml")) {
        ...
        check(MediaItemCodec.compatibilityKeys().get("remote").getNamespace().equals("customdiscs"),
