...
public final class UpdateDownloaderRegressionTest {
    ...
    public static void main(String[] args) throws Exception {
        byte[] jar = "paper-update".getBytes(StandardCharsets.UTF_8);
        ...
        var targetDir = Files.createTempDirectory("crabutilities-update-test");
        try {
            ...
            var downloaded = new UpdateDownloader("", "CrabUtilities regression test")
                    .download(release, targetDir, "CrabUtilities.jar");
            check(Arrays.equals(jar, Files.readAllBytes(downloaded)),
                    "the verified Paper update should be downloaded");
        } finally {
            server.stop(0);
