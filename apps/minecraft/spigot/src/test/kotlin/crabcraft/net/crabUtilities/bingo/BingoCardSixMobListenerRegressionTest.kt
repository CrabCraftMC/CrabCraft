...
object BingoCardSixMobListenerRegressionTest {
    ...
    private fun isolatesPersistentMarkersByCardResetAndAge() {
        ...
        check(!BingoCardSixMobListener.markerIsCurrent(
                        6, Int.MIN_VALUE, 19_000L, now, 7L, 7L, 2_000L),
    ...
    private fun defersPersistentCompletionsAcrossTheStartupCardGap() {
        check(BingoCardSixMobListener.shouldDeferPersistentCompletion(
                        6, Int.MIN_VALUE, true, true, 0, 300),
        ...
        check(!BingoCardSixMobListener.shouldDeferPersistentCompletion(
                        6, Int.MIN_VALUE, true, false, 0, 300),
                "An expired marker must not be deferred")
        check(!BingoCardSixMobListener.shouldDeferPersistentCompletion(
                        6, Int.MIN_VALUE, true, true, 300, 300),
    ...
    private fun invalidatesDelayedChecksAcrossResets() {
