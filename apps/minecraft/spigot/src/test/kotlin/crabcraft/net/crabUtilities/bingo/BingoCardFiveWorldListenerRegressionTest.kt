...
object BingoCardFiveWorldListenerRegressionTest {
    ...
    private fun recognizesBothBigDripleafBlocks() {
        check(
    ...
    private fun preservesBlockOwnershipAcrossSameCardRestarts() {
        ...
        val ownership =
                BingoCardFiveWorldListener.BlockOwnership(51, playerId, 9_000L)
    ...
    private fun preservesBlockKeyGeometry() {
        ...
        val origin =
                BingoCardFiveWorldListener.BlockKey(world, 10, 64, -3)
        check(
                origin.relative(BlockFace.NORTH)
                        .equals(BingoCardFiveWorldListener.BlockKey(world, 10, 64, -4)),
                "Horizontal Snow connectivity must remain in the same world and Y level")
        check(
                origin.withY(72)
                        .equals(BingoCardFiveWorldListener.BlockKey(world, 10, 72, -3)),
