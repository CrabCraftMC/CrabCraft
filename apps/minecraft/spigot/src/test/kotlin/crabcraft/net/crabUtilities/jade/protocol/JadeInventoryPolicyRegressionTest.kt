...
object JadeInventoryPolicyRegressionTest {
    private val INVENTORY_PROVIDER_IDS =
        setOf(
    ...
    fun main(args: Array<String>) {
        ...
        check(
            registered.none { it in INVENTORY_PROVIDER_IDS },
