...
object ReceiveDataPayloadRegressionTest {
    ...
    private fun keepsNormalResponsesUnchanged() {
        ...
        check(
            ReceiveDataPayload.prepareForSend(response, identity) === response,
    ...
    private fun trimsOversizedProviderData() {
        ...
        check(
            prepared.sizeInBytes() <= ReceiveDataPayload.MAX_SIZE,
    ...
    private fun fallsBackToTargetIdentity() {
        ...
        check(
            prepared.keySet().equals(identity.keySet()),
    ...
    private fun preservesEntityIdentity() {
        ...
        check(
            prepared.getIntOr("EntityId", 0) == 42,
    ...
    private fun checkBlockIdentity(tag: CompoundTag) {
        ...
        check(
            tag.getStringOr("BlockId", "").equals("minecraft:chest"),
