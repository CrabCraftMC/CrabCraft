...
object BingoCardSixWorldListenerRegressionTest {
    ...
    private fun requiresExactlyFourByFourPaintingDimensions() {
        check(
    ...
    private fun recognizesOnlyFishBuckets() {
        check(
    ...
    private fun keepsNamedGhastAttributionOnlyForTheCurrentCardAndPlayerRun() {
        ...
        check(
                !BingoCardSixWorldListener.markerIsCurrent(
                        61, Int.MIN_VALUE, 9_000L, now, 4L, 4L, 2_000L),
