...
class VoiceMediaRegistry private constructor() {
    ...
    fun serverApi(): VoicechatServerApi = serverApi ?: throw IllegalStateException("Simple Voice Chat is not ready")
    ...
    companion object {
        ...
        private fun addVolumeControl(
            ...
            api.registerVolumeCategory(
                api.volumeCategoryBuilder().setId(identifier).setName(displayName).setIcon(loadIcon(iconPath)).build()
            )
        }
