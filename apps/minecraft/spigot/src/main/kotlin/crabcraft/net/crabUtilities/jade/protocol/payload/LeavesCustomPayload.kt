...
/** Leaf-compatible marker annotations used to discover Jade's payload codecs. */
interface LeavesCustomPayload : CustomPacketPayload {
    ...
    @Target(AnnotationTarget.FIELD) @Retention(AnnotationRetention.RUNTIME) annotation class ID

    @Target(AnnotationTarget.FIELD) @Retention(AnnotationRetention.RUNTIME) annotation class Codec
