...
enum class BingoTask(
    ...
    companion object {
        private val CARD_ONE: List<BingoTask> = java.util.List.of(
                GROW_TREE_IN_NETHER,
                PLAY_FIVE_GOAT_HORNS,
                CONNECT_ALL_ORE_TYPES,
                ACTIVATE_TOTEM,
                ...
                COLLAPSE_SCAFFOLDING_TOWER,
                BREED_TRUSTING_FOX)
        private val CARD_TWO: List<BingoTask> = java.util.List.of(
                SHEAR_BOGGED,
                RING_BELL_PROJECTILE,
                BERRY_BUSH_KILL,
                DRY_SPONGE_NETHER,
                ...
                CREEPER_RINGS_BELL,
                MINE_COPPER_GOLEM_STATUE)
        private val CARD_THREE: List<BingoTask> = java.util.List.of(
                SULFUR_CUBE_TNT_IGNITE,
                BREED_THIRD_COLOUR_SHEEP,
                UNLOCK_OMINOUS_VAULT,
                FOX_USES_TOTEM,
                ...
                GOLDEN_DANDELION_HOGLIN,
                FOUR_COPPER_TRUMPET_SOUNDS)
        private val CARD_FOUR: List<BingoTask> = java.util.List.of(
                SULFUR_CUBE_DIAMOND_BUCKET,
                SNOW_GOLEM_KILLS_BLAZE,
                FOUR_BY_FOUR_NETHER_PORTAL,
                CROSSBOW_FIREWORK_KILL_TWO,
                ...
                FREEZE_SKELETON_STRAY,
                SCULK_CATALYST_PLAYER_KILL)
        private val CARD_FIVE: List<BingoTask> = java.util.List.of(
                BUILD_TEN_TALL_DRIPLEAF,
                MOB_EQUIPS_DROPPED_HELMET,
                CLEAN_BANNER_PATTERN,
                FEED_PANDA_CAKE,
                ...
                PLAYER_END_CRYSTAL_HOSTILE_KILL,
                WEAR_FOUR_ARMOUR_MATERIALS)
        private val CARD_SIX: List<BingoTask> = java.util.List.of(
                HANG_FOUR_BY_FOUR_PAINTING,
                OUTLINE_HANGING_SIGN,
                FILL_CAMPFIRE_FOUR_SLOTS,
                SHOOT_BUTTON_WITH_ARROW,
                ...
                APPLY_ARMOUR_TRIM,
                FOUR_SHERD_DECORATED_POT)
        private val ALL_DEPLOYED: List<BingoTask> = java.util.List.copyOf(entries)

        private val BY_ID: Map<String, BingoTask>

        init {
            val tasksById = LinkedHashMap<String, BingoTask>()
            for (task in entries) {
                val previous = tasksById.put(task.id, task)
                if (previous != null) {
                    throw IllegalStateException("Duplicate bingo task ID: " + task.id)
                }
            }
        ...
        @JvmStatic
        fun cardOne(): List<BingoTask> = CARD_ONE

        @JvmStatic
        fun cardTwo(): List<BingoTask> = CARD_TWO

        @JvmStatic
        fun cardThree(): List<BingoTask> = CARD_THREE

        @JvmStatic
        fun cardFour(): List<BingoTask> = CARD_FOUR

        @JvmStatic
        fun cardFive(): List<BingoTask> = CARD_FIVE

        @JvmStatic
        fun cardSix(): List<BingoTask> = CARD_SIX

        @JvmStatic
        fun allDeployed(): List<BingoTask> = ALL_DEPLOYED

        @JvmStatic
        fun fromId(id: String?): Optional<BingoTask> = Optional.ofNullable(BY_ID[id])
    }
}
