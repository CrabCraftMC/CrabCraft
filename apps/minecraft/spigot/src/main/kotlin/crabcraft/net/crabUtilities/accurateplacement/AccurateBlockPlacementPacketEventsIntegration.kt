...
/** Loads PacketEvents types only after the optional dependency has been confirmed. */
            ...
            eventManager.registerListener(
                object : PacketListener {
                    override fun onPacketReceive(event: PacketReceiveEvent) {
                        ...
                        if (!manager.capture(player, position.x, position.y, position.z, cursor.x, packet.sequence))
                            return
