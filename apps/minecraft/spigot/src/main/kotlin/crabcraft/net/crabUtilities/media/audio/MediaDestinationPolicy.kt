...
/** Approves destinations and returns their resolved addresses to avoid a second DNS lookup. */
...
private constructor(
    ...
    class ApprovedDestination(private val uri: URI, addresses: Array<InetAddress>) {
        private val addresses = addresses.clone()
        ...
        override fun equals(other: Any?): Boolean =
            this === other || other is ApprovedDestination && uri == other.uri && addresses === other.addresses

        override fun hashCode(): Int = 31 * uri.hashCode() + System.identityHashCode(addresses)

        override fun toString(): String = "ApprovedDestination[uri=$uri, addresses=$addresses]"
    ...
    @Throws(IOException::class) fun approveConfiguredProxy(value: String?): ApprovedDestination = approve(value, true)
    ...
    companion object {
        /** Protected-network exception reserved for the administrator-owned lofi source. */
        @JvmStatic
        fun forTrustedLofiConfiguration(): MediaDestinationPolicy =
            MediaDestinationPolicy(Resolver(InetAddress::getAllByName), true)

        @JvmStatic
        fun isProtected(address: InetAddress): Boolean {
            if (
            ...
            if (address is Inet6Address) {
                // Global unicast is public. Other special-purpose IPv6 ranges fail closed.
        ...
        @JvmStatic
        fun addressLiteral(address: InetAddress): String {
